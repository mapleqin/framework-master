...
public class TableUtils {
    ...
    public static String getTableName(Class<?> entityType) {
        com.toaker.commons.db.annotation.Table table = entityType.getAnnotation( com.toaker.commons.db.annotation.Table.class);
    ...
    static synchronized Id getId(Class<?> entityType) {
        ...
        if (fields != null) {
            ...
            for (Field field : fields) {
                if (field.getAnnotation( com.toaker.commons.db.annotation.Id.class) != null) {
